      ...
      >
        <div className="mx-auto max-w-screen-2xl">
          <div className="grid items-center gap-20 lg:grid-cols-12">
              ...
              <div className="relative h-[500px] sm:h-[600px] lg:h-[750px] lg:col-span-7 order-1 lg:order-1">
                <div className="absolute inset-0 flex items-center justify-center border border-white/5 bg-charcoal/10 overflow-hidden">
                  {/* Molecular Grid Animation - new */}
                  <div className="absolute inset-0 z-0 bg-[radial-gradient(var(--tw-gradient-stops))] from-gold/5 via-gold/0 to-gold/0 opacity-20 animate-molecular-grid-fade" />
                  <div className="absolute inset-0 z-0 bg-[length:60px_60px] [background-image:linear-gradient(to_right,rgba(196,168,105,0.05)_1px,transparent_1px),linear-gradient(to_bottom,rgba(196,168,105,0.05)_1px,transparent_1px)] animate-grid-pulse" />
                  ...
                  <div className="glass-noir p-10 border border-white/5 rotate-1">
                    <div className="flex flex-col gap-6">
                        ...
                        <div className="space-y-1">
                          ...
                          <CountingText
                            value="VVS1 — IF"
                            className="font-serif text-2xl font-extralight text-foreground"
                          />
                        </div>
                    </div>
                  </div>
              ...
              {/* ── Text Side ── */}
              <div className="lg:col-span-5 order-2 lg:order-2 relative z-10">
                <div className="max-w-xl">
                  ...
                  <div className="mt-16 hidden md:grid grid-cols-2 gap-12 border-t border-white/5 pt-12 animate-fade-in-up delay-400">
                    <div className="space-y-2">
                      <CountingText value={100} className="font-serif text-4xl font-extralight text-foreground" />
                      <p className="text-[9px] font-bold tracking-[0.25em] uppercase text-gold/60">Conflict Free</p>
                    </div>
                    <div className="space-y-2">
                      <CountingText value="Carbon" className="font-serif text-4xl font-extralight text-foreground" />
